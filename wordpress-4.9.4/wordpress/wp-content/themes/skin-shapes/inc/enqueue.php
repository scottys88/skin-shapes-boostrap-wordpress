...
if ( ! function_exists( 'understrap_scripts' ) ) {
	...
	function understrap_scripts() {
		...
		wp_enqueue_script( 'instafeed', get_template_directory_uri() . '/js/instafeed.min.js',  array( 'jquery' ), null, false);
		wp_enqueue_script( 'slick-slider', get_template_directory_uri() . '/js/slick.js', false, null, false);
